...
module.exports = class Config {
  ...
  static createInstance ( dir, name, ...args) {
    if ( ! this._instances ) this._instances = {}
    return this._instances[name] = new this(...args)
  }

  static createInstanceCheck ( dir, name, ...args ) {
    if ( this._instances && this._instances[name] ) throw new Error(`Config already Exists [${name}]`)
    return this.createInstance( name, ...args )
  }
